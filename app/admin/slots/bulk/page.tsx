...
export default function BulkCreatePage() {
    return (
        <div className="max-w-4xl">
            ...
            <div className="mb-12">
                <h1 className="text-4xl font-extrabold font-outfit tracking-tighter">Bulk Create Slots</h1>
                <p className="text-zinc-500 mt-1">Generate multiple slots across a date range at once.</p>
            </div>
